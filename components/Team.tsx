...
const Team = () => {
    return (
        <div className='w-full'>
            <div className='p-2'>
                <h1 className='text-2xl text-dark_green font-semibold'>Our Dedicated <span className='text-light_green'>Team</span></h1>
                <p className='text-dark_green text-lg mb-2'>The experts behind Agob Synergy—united by passion, innovation, and commitment.</p>
            </div>
            <div className='p-2'>
                {
                    Teams?.map((team) => (
                        <div key={team.id} className='my-4 shadow-2xl shadow-light_green/40'>
                            ...
                            <div className='px-3 py-8 flex flex-col items-center justify-center'>
                                <p className='text-lg text-dark_green'>{team.title}</p>
                                <p className='text-lg text-dark_green font-semibold mb-4'>{team.name}</p>
